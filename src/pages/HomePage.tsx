    ...
    <div>
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <p style={{ 
              ...
              Premium quality paving blocks, cobblestones, and kerb stones for durability and excellence
            </p>
          </div>
            ...
            >
              <div style={{
                ...
                >
                  <source
                    src={
                      category.categoryKey === 'cabro' ? '/Videos/Carbropavingblocks.mp4' :
                      category.categoryKey === 'cobblestone' ? '/Videos/Cobblestones.mp4' :
                ...
                <div style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'linear-gradient(135deg, rgba(0, 102, 204, 0.45), rgba(220, 38, 38, 0.45))',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: 'white',
            ...
            {featuredProducts.map((product) => (
              ...
              >
                ...
                <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                  <h3 style={{ color: 'var(--primary-blue)', marginBottom: '0.5rem', marginTop: 0 }}>
                    {product.name}
                  </h3>
                  <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', flex: 1, marginBottom: '1rem', margin: 0 }}>
                    {product.description}
                  </p>
                  <button style={{
          ...
          {designShowcase.map((design) => (
            ...
            >
              ...
              <div style={{ padding: '1rem', background: 'white' }}>
                <h3 style={{ color: 'var(--primary-blue)', margin: 0, marginBottom: '0.5rem' }}>
                  {design.name}
                </h3>
            ...
            {projectShowcase.map((project) => (
              ...
              >
                ...
                <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '0.5rem', margin: 0 }}>
                    📍 {project.location}
                  </p>
                  <span style={{
                    display: 'inline-block',
      ...
      <section style={{
        ...
        <p style={{
          ...
          Get an instant estimate for your cabro paving project. Our advanced calculator includes material costs, installation options, and delivery fees.
        </p>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {[
              { icon: '✓', title: 'Quality Materials', desc: 'Premium grade cabro blocks and kerb stones' },
              { icon: '✓', title: 'Professional Installation', desc: 'Expert installation by trained professionals' },
              { icon: '✓', title: 'Fast Delivery', desc: 'Quick delivery to your location in Kenya' },
              { icon: '✓', title: 'Competitive Prices', desc: 'Best prices without compromising quality' }
            ].map((benefit, idx) => (
              <div
                key={idx}
                style={{
      ...
      <DesignVisualizer isOpen={showDesignVisualizer} onClose={() => setShowDesignVisualizer(false)} />
    </div>
  );
};
