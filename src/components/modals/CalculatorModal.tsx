      ...
      >
        ...
        >
          ...
          {!estimate ? (
            <>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                >
                  ...
                  <option value="professional">Professional Installation (KES 200/m²)</option>
                </select>
              </div>
            ...
            <>
              {/* Results Section */}
              <div style={{ background: 'var(--primary-blue-lighter)', padding: '1.5rem', borderRadius: 'var(--radius-md)', marginBottom: '1.5rem' }}>
                <h3 style={{ color: 'var(--primary-blue)', marginTop: 0, marginBottom: '1rem' }}>Estimate Breakdown</h3>

                <div style={{ display: 'grid', gap: '1rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '0.5rem', borderBottom: '1px solid var(--gray-border)' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '0.5rem', borderBottom: '1px solid var(--gray-border)' }}>
                    ...
                    <strong>{estimate.paversNeeded.toLocaleString()} pieces</strong>
                  </div>

                  <div style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '2px solid var(--primary-blue)' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginBottom: '1rem' }}>
                💡 This is an approximate estimate. Actual costs may vary based on location and project requirements.
              </p>
